            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Alumni Accounts</h4>
                    </div>
...
// Function to change OJT status from 'Done' to 'Ongoing'
function setOngoingOJT($ID) {
    global $connection;
    ...
    if (isset($_GET['action'])) {
        switch ($_GET['action']) {
            ...
            case 'completeOJT':
                ...
                break;
            case 'setOngoingOJT':
                setOngoingOJT($ID); // Corrected function call here
                break;
            default:
                echo "Invalid action.";
        }
...
// Fetch approved user registrations with OJT status set to 'Done'
$sql_approved = "SELECT *, IFNULL(locked, 0) AS locked FROM user_data WHERE STATUS = 'approve' AND OJT = 'Done'";
...
// Read data of each row for approved registrations with OJT status set to 'Done'
while($row = $result_approved->fetch_assoc()){
    ...
    <tr>
        ...
        <td>Done</td> <!-- Displaying 'Done' instead of 'Ongoing' -->
        <td>
        ...
        <td>
            ...
            <a href='dashboard4.php?ID={$row["ID"]}&action=setOngoingOJT'><i class='fas fa-times'></i></a> <!-- Icon to mark OJT as Ongoing -->
