...
$user_id = $_GET['id']; // Retrieve the user's ID from the URL parameter

// Directory where the uploaded files are stored
$upload_directory = "../user/uploads/$user_id/";
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <aside class="left-sidebar">
            ...
            <a href="chat.php?receiver_id=<?php echo $user_id; ?>" class="btn btn-primary">Chat User</a>
    ...
    <tr>
        <td style="vertical-align: middle; text-align: center; height: 100%;">
            ...
            <h3>Choose a file from user <?php echo htmlspecialchars($user_id); ?></h3>
