            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">For Registration</h4>
                    </div>
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['ID'])) {
                                    ...
                                    if (isset($_GET['action'])) {
                                        switch ($_GET['action']) {
                                            ...
                                            $sql_pending = "SELECT * FROM user_data WHERE STATUS = 'pending'";
                                            ...
                                            while($row = $result_pending->fetch_assoc()){
                                                ...
                                                <td>{$row['STUDENT_CONTACT']}</td>
                                                    <td>
                                                        <a style='padding: 1px 1px; font-size: 12px;'href='dashboard2.php?ID={$row["ID"]}&action=approve'>Approve</a>
                                                        <a style='padding: 1px 1px; font-size: 12px;'href='dashboard2.php?ID={$row["ID"]}&action=reject'>Reject</a>
                                                     </td>
                                                </tr>
                                                ";
                                            }
